        ...
        <Row className='justify-content-md-center my-2'>
          <Col md="5">
            <div className='text-center'>
              ...
              <h2 className='font-weigth-600 text-lg mt-2 mb-4'>
                Gracias por comprar en <br/> Connectus
              </h2>
            </div>
            <Card className="shadow my-3">
              <CardHeader className="border-bottom border-2">
                <h3 className="pt-2 pr-3">
                  Próximos Pasos
                </h3>
              </CardHeader>
              <CardBody className='p-3'>
                <p className='font-weight-600'>
                  Estamos validando tu compra, te avisaremos cuando tus crédito queden activos
                </p>
              </CardBody>
            </Card>
            <Card className="shadow my-3">
              <CardHeader className="border-bottom border-2">
                <h3 className="pt-2 pr-3">
                  ...
                  <br/>
                  <span className='text-muted font-weigth-100 d-inline-block text-sm'>Pedido 48867079</span>
                </h3>
              </CardHeader>
              <CardBody className='p-3'>
            ...
            <Card className="shadow my-3">
              ...
              <CardBody>
                ...
                <Row>
                  <Col>
                    <a href="#" className="mb-1 text-xs">
                      Pago en 3 cuotas sin interes
                    </a>
                  </Col>
                </Row>
                <Row>
                ...
                <Row>
                  <Col>
                    <p className="mb-1 text-xs">
                      Pago #88579957 acreditado el 05 de Mayo
                    </p>
                  </Col>
                </Row>
              </CardBody>
            ...
            <Button onClick={() => setStep(1)} className="my-4" color="info" outline type="button" block>
              Regresar
            </Button>
          </Col>
        </Row>
